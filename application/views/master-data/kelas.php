    <!-- Content Wrapper -->
                                ...
                                <?php foreach ($role as $r) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a data-toggle="modal" data-target="#newEditKelasModal<?= $r['id_level']; ?>" href="<?= base_url() ;?>Menu/editLevel/<?= $r['id_level'] ;?>" class="btn btn-warning btn-circle btn-sm">
        ...
        <?php
            ...
            $a++;
        ?>
        <div class="modal fade" id="newEditKelasModal<?= $row['id_level']; ?>" tabindex="-1" role="dialog" aria-labelledby="newEditKelasModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
